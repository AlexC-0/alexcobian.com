(function () {
  const translations = {
    es: {
      ...
      pageDescription: "Portfolio profesional de Alex Cobian: desarrollo web, experiencia actual en Shackleton Innovation, competencias DAW y Salesforce.",
      ogTitle: "Alex Cobian | Desarrollador Web",
      ogDescription: "Portfolio profesional de Alex Cobian: desarrollo web, experiencia actual en Shackleton Innovation, competencias DAW y Salesforce.",
      ...
      heroBody: "Desarrollador web con conocimientos en HTML, CSS, Java, JavaScript, PHP, Node.js y SQL para aplicaciones web. Actualmente trabajo en Shackleton Innovation, donde aplico desarrollo web en tareas reales de frontend, backend, APIs, datos e incidencias, traduciendo requisitos ambiguos en soluciones concretas y mantenibles. En paralelo sigo profundizando en el ecosistema Salesforce y en Apex a traves de Trailhead.",
    ...
    en: {
      ...
      pageDescription: "Professional portfolio of Alex Cobian: web development, current experience at Shackleton Innovation, DAW skills, and Salesforce.",
      ogTitle: "Alex Cobian | Web Developer",
      ogDescription: "Professional portfolio of Alex Cobian: web development, current experience at Shackleton Innovation, DAW skills, and Salesforce.",
